...
"build": {
    "name" : "<%= props.get("enteucha.build.name") %>",
    "version" : "<%= props.get("enteucha.build.version") %>",
    "timestamp" : "<%= props.get("enteucha.build.timestamp") %>",
    "changeset" : "<%= props.get("enteucha.build.changeset").toString().replace("+", "") %>"
    },
"system": {
